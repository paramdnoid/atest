        ...
        <TableHeader className="sticky top-0 z-10 bg-muted/85 backdrop-blur supports-backdrop-filter:bg-muted/75">
          <TableRow className="hover:bg-transparent">
            ...
            {visibleColumns.includes('priority') && (
              <TableHead className="px-4 py-3 text-xs font-semibold tracking-wide text-muted-foreground">Prioritaet</TableHead>
            )}
            ...
            {visibleColumns.includes('validUntil') && (
              <TableHead className="px-4 py-3 text-xs font-semibold tracking-wide text-muted-foreground">Gueltig bis</TableHead>
            )}
            {visibleColumns.includes('margin') && (
              <TableHead className="px-4 py-3 text-xs font-semibold tracking-wide text-muted-foreground">Marge</TableHead>
            )}
            {visibleColumns.includes('totalNet') && (
              <TableHead className="px-4 py-3 text-xs font-semibold tracking-wide text-muted-foreground">Netto</TableHead>
            )}
