  ...
  return (
    <div className="space-y-3">
      <ModuleTableCard
        ...
        title={record.number}
        hasData
        headerBottomContent={<div aria-hidden="true" className="h-1" />}
      >
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between rounded-lg border border-border/70 bg-background/95 px-3 py-2">
