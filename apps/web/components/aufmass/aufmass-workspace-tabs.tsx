...
import {
  AUFMASS_WORKSPACE_TABS,
  getReviewBadgeLabel,
  getTabAriaLabel,
  getWorkspaceTabByKey,
  hasReviewBadge,
  type AufmassWorkspaceTab,
} from '@/lib/aufmass/workspace-tabs';
import { cn } from '@/lib/utils';

export type { AufmassWorkspaceTab };
...
const tabs: Array<{
  ...
  { ...AUFMASS_WORKSPACE_TABS[0], icon: DraftingCompass },
  { ...AUFMASS_WORKSPACE_TABS[1], icon: ShieldCheck },
