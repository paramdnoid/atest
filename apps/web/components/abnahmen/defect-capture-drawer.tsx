        ...
        <div className="grid gap-3 p-4 pt-0 sm:grid-cols-2">
          ...
          <div className="space-y-2 sm:col-span-2">
            ...
            <textarea
              ...
              className="min-h-24 w-full rounded-md border border-input/80 bg-background px-3 py-2 text-sm outline-none transition-colors focus-visible:ring-2 focus-visible:ring-ring/40"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="h-9 w-full rounded-md border border-input/80 bg-background px-3 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-ring/40"
            >
