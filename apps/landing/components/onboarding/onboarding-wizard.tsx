...
const DEFAULT_PLANS: OnboardingPlan[] = [
  {
    code: "starter",
    name: "Starter",
    description: "Für kleinere Betriebe und Einsteiger",
    trialDays: 14,
    ...
    featureHighlights: ["5 Nutzer", "10 GB Speicher", "14 Tage Testphase"],
  },
  {
    code: "pro",
    name: "Pro",
    description: "Für wachsende Betriebe mit mehr Bedarf",
    trialDays: 14,
    ...
    purchasableMonthly: true,
    purchasableYearly: true,
    featureHighlights: ["Unbegrenzt Nutzer", "100 GB Speicher", "DATEV Export", "14 Tage Testphase"],
  },
  {
    code: "enterprise",
    name: "Enterprise",
    description: "Für große Betriebe und Unternehmen",
    trialDays: 0,
    priceMonthlyCents: -1,
    ...
    featureHighlights: ["Individuell", "Dedizierter Support", "SLA"],
  },
];
