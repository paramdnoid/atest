...
const variantOrbs: Record<GlowVariant, ReactNode> = {
  ...
  subtle: (
    <>
      <div className="animate-glow-pulse absolute top-1/4 left-1/4 h-96 w-96 rounded-full bg-primary/4 blur-[120px]" />
      <div className="animate-glow-pulse absolute right-1/4 bottom-1/4 h-80 w-80 rounded-full bg-amber-500/3 blur-[100px] [animation-delay:2s]" />
    </>
  ),
  centered: (
    <>
      <div className="animate-glow-pulse absolute top-1/2 left-1/4 h-100 w-100 -translate-y-1/2 rounded-full bg-primary/6 blur-[100px]" />
