...
const staticPlans: PublicPlan[] = [
  {
    ...
    name: "Starter",
    description:
      "Ideal für kleine Handwerksbetriebe, die digital durchstarten wollen.",
    priceMonthly: 4900,
    priceYearly: 49000,
    trialDays: 30,
    isPopular: true,
  ...
  },
  {
    ...
    name: "Enterprise",
    description:
      "Individuelle Lösungen für große Betriebe mit eigenem Support und SLA.",
    priceMonthly: -1,
    priceYearly: null,
    trialDays: 0,
    isPopular: false,
    ctaText: "Kontakt aufnehmen",
    ctaLink: "mailto:vertrieb@zunftgewerk.de",
    features: [
