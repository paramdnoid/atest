...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="py-16 sm:py-20 md:py-32" aria-labelledby="how-it-works-heading">
      <SectionContainer>
        <FadeIn className="mx-auto mb-12 max-w-2xl text-center md:mb-20">
          <p className="text-primary mb-3 text-xs font-bold tracking-[0.15em] uppercase sm:mb-4">So funktioniert&apos;s</p>
          <h2
        ...
        <StaggerChildren
          className="mx-auto grid max-w-7xl gap-7 sm:gap-8 md:grid-cols-3 md:gap-6 lg:gap-12"
          staggerDelay={0.15}
        >
          {steps.map((item, index) => (
            <StaggerItem key={item.step}>
              <div className="group relative text-center">
                ...
                <div className="from-primary/10 shadow-card ring-primary/10 group-hover:shadow-card-hover group-hover:ring-primary/20 mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-linear-to-br to-primary/5 ring-1 ring-inset transition-all duration-500 sm:mb-6 sm:h-24 sm:w-24">
                  <span
                    className="animate-gradient-x from-primary bg-linear-to-r to-amber-500 bg-clip-text text-2xl font-extrabold text-transparent sm:text-3xl"
